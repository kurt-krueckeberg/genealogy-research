...
|===
|PersonID Int (Prim Key) |UniqueID TEXT |Sex Int |ParentID Int |SpouseID Int |Color Int |Relate1 Int |Relate2 Int |Flags Int |Living Int
...
- Look into an alternate solution of:
  ...
  - Converting GEDCOM 5 to GECOM X, and then

  - Using Gecom X library to extract the details.
