...
- `SpouseID` is almost always zero (meaming no spouse?). When not zero, it is like a foreign key referencing `FamilyTable.FamilyID`.
- `Living` is boolean 
- `Color`
...
FamilyTable	FamilyID	I	PRIMARY	1,2,3...	Family Identification Number
FamilyTable	FatherID	I		1,2,3...	Father Identification Number, linking to PersonID of PersonTable
FamilyTable	MotherID	I		1,2,3...	Mother Identification Number, linking to PersonID of PersonTable
FamilyTable	ChildID	I		0,1,2,...	Child Identification Number, linking to PersonID of PersonTable (0 if no children) [RIN of one of children, possibly last active in Pedigree view, others?]
FamilyTable	HusbOrder	I		0,1,2,...	Husband Order, from Rearrange Spouses screen (0 if never rearranged) [some oddities, such as value of 2, but only one husband?]
FamilyTable	WifeOrder	I		0,1,2,...	Wife Order, from Rearrange Spouses screen (0 if never rearranged) [some oddities such as value of 2, but only one wife?]
FamilyTable	IsPrivate	I		0,1	Private, from Edit Person screen (0 = Not Private (unchecked), 1 = Private (checked))
FamilyTable	Proof	I		0-3	Proof, from Edit Person screen (0 = [blank], 1 = Proven, 2 = Disproven, 3 = Disputed)
FamilyTable	SpouseLabel	I		0	not currently supported?
FamilyTable	FatherLabel	I		0-2	Husband label, from Edit Person screen (0 = Father, 1 = Husband, 2 = Partner)
FamilyTable	MotherLabel	I		0-2	Wife label, from Edit Person screen (0 = Mother, 1 = Wife, 2 = Partner)
FamilyTable	Note	B		Text	Note, from Edit Person screen
