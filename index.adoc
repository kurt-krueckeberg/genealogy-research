...
For mapping Township and Range Numbers to township names, see https://www.acres.co/plat-map[acres.co]
List of Allen county, Indiana, townships by their township and range numbers:

.Allen County Township Names by PLSS Designation
