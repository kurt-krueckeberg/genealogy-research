...
The small village of Fellinghausen, in the Grand Duchy of Hessen, is short distance from the larger village of Rodhein an der Bieber (an der Bieber = on the Bieber river), which was renamed in the 1950s as
Rodheim-Bieber.  Fellinghuasen and Rodheim an der Bieber shared the same 
