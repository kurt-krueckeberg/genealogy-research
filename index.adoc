...
- https://www.in.gov/iara/divisions/state-archives/collections/naturalization-records/[Naturlatizatoin Records], which explains the naturalization process:
...
Theis section describe place to find nationuralzaion records, including the Indiana State Archives and other volumes and local record repositories.
