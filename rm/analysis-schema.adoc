...
[source]
----
select n.Surname as Surname, n.Given as given, n.BirthYear as birth_year, n.Deathyear as death_year, n.IsPrimary, p.Sex as sex from PersonTable as p join NameTable as n on p.PersonID=n.OwnerID order by NameID, OwnerID;
----
