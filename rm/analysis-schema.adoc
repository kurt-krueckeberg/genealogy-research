...
[source]
----
select n.Surname as Surname, n.Given as given, n.OwnerID, n.NameID, p.Sex as sex, n.BirthYear as birth_year, n.DeathYear as death_year, n.IsPrimary from NameTable as n join PersonTable as p on p.PersonID=n.OwnerID order by lower(Surname), lower(Given), NameID, OwnerID;
----
