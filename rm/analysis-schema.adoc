...
[source]
----
select n.Surname as Surname, n.given as given, n.BirthYear birth_year, n.Deathyear as death_year, n.IsPrimay, p.Sex as sex, from PersonTable as p join NameTable as n on p.PersonID=n.OwnerID order by NameId, OwnerID;
----
